...
;//! \htmlinclude Num2.msg.html

(cl:defclass <Num2> (roslisp-msg-protocol:ros-message)
  ((first_name
    :reader first_name
    :initarg :first_name
    :type cl:string
...
(cl:defclass Num2 (<Num2>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Num2>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Num2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<Num2> is deprecated: use beginner_tutorials-msg:Num2 instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Num2>))
...
(cl:defmethod last_name-val ((m <Num2>))
...
(cl:defmethod score-val ((m <Num2>))
  ...
  (score m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Num2>) ostream)
  "Serializes a message object of type '<Num2>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Num2>) istream)
  "Deserializes a message object of type '<Num2>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Num2>)))
  "Returns string type for a message object of type '<Num2>"
  "beginner_tutorials/Num2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Num2)))
  "Returns string type for a message object of type 'Num2"
  "beginner_tutorials/Num2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num2>)))
  "Returns md5sum for a message object of type '<Num2>"
  "f8bfa80ae3c7a93455596d9622ad33a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num2)))
  "Returns md5sum for a message object of type 'Num2"
  "f8bfa80ae3c7a93455596d9622ad33a9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num2>)))
  "Returns full string definition for message of type '<Num2>"
  (cl:format cl:nil "string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num2)))
  "Returns full string definition for message of type 'Num2"
  (cl:format cl:nil "string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Num2>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Num2>))
